...
/* Includes ------------------------------------------------------------------- */
#include "includes/lpc17xx_adc.h"
#include "includes/lpc17xx_clkpwr.h"
...
#else
#include "includes/lpc17xx_libcfg_default.h"
...
* 				- ADC_ADGINTEN: Individual channel/global flag done 
